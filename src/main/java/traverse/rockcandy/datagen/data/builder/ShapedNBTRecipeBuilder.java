...
public class ShapedNBTRecipeBuilder implements RecipeBuilder {
	...
	public ShapedNBTRecipeBuilder define(Character p_126128_, ItemLike p_126129_) {
		return this.define(p_126128_, Ingredient.of(p_126129_));
	}

	public ShapedNBTRecipeBuilder define(Character p_126125_, Ingredient p_126126_) {
	...
	public ShapedNBTRecipeBuilder pattern(String p_126131_) {
	...
	public ShapedNBTRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
		this.advancement.addCriterion(p_126133_, p_126134_);
		return this;
	}

	public ShapedNBTRecipeBuilder group(@Nullable String p_126146_) {
	...
	public static class Result implements FinishedRecipe {
		...
		public Result(ResourceLocation id, ItemStack result, int count, String group, List<String> pattern, Map<Character, Ingredient> key, Advancement.Builder advancement, ResourceLocation advancementId) {
			this.id = id;
			this.result = result;
			this.count = count;
			this.group = group;
