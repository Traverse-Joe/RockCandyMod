...
public class InfuserRecipeHandler {
    ...
    public InfuserRecipeHandler() {
        ...
        this.addInfuserForItems(Items.FERMENTED_SPIDER_EYE, new ItemStack(ModItems.itemClearCandy));
        this.addInfuserForItems(Items.SHULKER_SHELL , new ItemStack(ModItems.itemFloatCandy));
        this.addInfuserForItems(Items.GHAST_TEAR, new ItemStack(ModItems.itemHealthyCandy));
    ...
    public void addInfuserForItems(IItemProvider input, ItemStack stack) {
        this.addInfuserRecipe(new ItemStack(input, 1, 0), stack);
    }
